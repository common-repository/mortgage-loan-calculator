...
define('MLCALC_URL', plugins_url( '', __FILE__));
...
function mlcalc_control() {
	...
	if ( !empty($_POST['mlcalc-submit'] )) {
		$newoptions['title']              = sanitize_title($_POST['mlcalc-title']);
		$newoptions['default_calculator'] = sanitize_text_field($_POST['mlcalc-default_calculator']);
		$newoptions['form_size']          = sanitize_text_field($_POST['mlcalc-form_size']);
		$newoptions['currency_code']      = sanitize_text_field($_POST['mlcalc-currency_code']);
		$newoptions['interest_rate']      = sanitize_text_field($_POST['mlcalc-interest_rate']);
		$newoptions['purchase_price']     = sanitize_text_field($_POST['mlcalc-purchase_price']);
		$newoptions['mortgage_term']      = sanitize_text_field($_POST['mlcalc-mortgage_term']);
		$newoptions['down_payment']       = sanitize_text_field($_POST['mlcalc-down_payment']);
		$newoptions['property_tax']       = sanitize_text_field($_POST['mlcalc-property_tax']);
		$newoptions['property_insurance'] = sanitize_text_field($_POST['mlcalc-property_insurance']);
		$newoptions['pmi']                = sanitize_text_field($_POST['mlcalc-pmi']);
		$newoptions['loan_amount']        = sanitize_text_field($_POST['mlcalc-loan_amount']);
		$newoptions['loan_term']          = sanitize_text_field($_POST['mlcalc-loan_term']);
		$newoptions['amortization']       = sanitize_text_field($_POST['mlcalc-amortization']);
		$newoptions['language']           = sanitize_text_field($_POST['mlcalc-language']);
	}
...
?>
		...
		<p><a href="https://www.mlcalc.com/mortgage-calculator/" onclick="(typeof jQuery != 'undefined') ? jQuery('.mlcalc_default_values').show() : document.getElementById('mlcalc_default_values').style.display = 'inline'; this.style.display = 'none'; return false;">Change default values...</a></p>
		...
		<p><label for="mlcalc-down_payment"><?php _e( 'Down payment' ); ?> <small>(<a href="https://www.mlcalc.com/mortgage-calculator/" onclick="(typeof jQuery != 'undefined') ? jQuery('.mlcalc-down_payment').val('null') : document.getElementById('mlcalc-down_payment').value='null'; return false;">hide this field</a>)</small>: <br /> <input style="width: 35px; text-align: center;" type="text" value="<?php echo $down_payment; ?>" name="mlcalc-down_payment" id="mlcalc-down_payment" class="mlcalc-down_payment" /> %</label></p>
		...
		<p><label for="mlcalc-property_tax"><?php _e( 'Property tax' ); ?> <small>(<a href="https://www.mlcalc.com/mortgage-calculator/" onclick="(typeof jQuery != 'undefined') ? jQuery('.mlcalc-property_tax').val('null') : document.getElementById('mlcalc-property_tax').value='null'; return false;">hide this field</a>)</small>: <br /> <input style="width: 65px; text-align: center;" type="text" value="<?php echo $property_tax; ?>" name="mlcalc-property_tax" id="mlcalc-property_tax" class="mlcalc-property_tax" /> $ per year</label></p>
		<p><label for="mlcalc-property_insurance"><?php _e( 'Property insurance' ); ?> <small>(<a href="https://www.mlcalc.com/mortgage-calculator/" onclick="(typeof jQuery != 'undefined') ? jQuery('.mlcalc-property_insurance').val('null') : document.getElementById('mlcalc-property_insurance').value='null'; return false;">hide this field</a>)</small>: <br /> <input style="width: 65px; text-align: center;" type="text" value="<?php echo $property_insurance; ?>" name="mlcalc-property_insurance" id="mlcalc-property_insurance" class="mlcalc-property_insurance" /> $ per year</label></p>
		<p><label for="mlcalc-pmi"><?php _e( 'PMI' ); ?> <small>(<a href="https://www.mlcalc.com/mortgage-calculator/" onclick="(typeof jQuery != 'undefined') ? jQuery('.mlcalc-pmi').val('null') : document.getElementById('mlcalc-pmi').value='null'; return false;">hide this field</a>)</small>: <br /> <input style="width: 35px; text-align: center;" type="text" value="<?php echo $pmi; ?>" name="mlcalc-pmi" id="mlcalc-pmi" class="mlcalc-pmi" /> %</label></p>
